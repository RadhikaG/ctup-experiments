...
////// SPARSE, BLOCKED //////
/// Combos supported:
/// * UNROLLED, UNCOMPRESSED
/// * FLATTENED, UNCOMPRESSED
...
struct Rotation : public matrix_layout<Scalar> {
  ...
  Rotation() : matrix_layout<Scalar>(3, 3, SPARSE, UNROLLED, UNCOMPRESSED) {
...
struct XformBlocked : public blocked_layout<Scalar> {
  ...
  XformBlocked() : blocked_layout<Scalar>(6, 6), 
    ...
    minus_E_rcross(new matrix_layout<Scalar>(3, 3, SPARSE, UNROLLED, UNCOMPRESSED)) {
